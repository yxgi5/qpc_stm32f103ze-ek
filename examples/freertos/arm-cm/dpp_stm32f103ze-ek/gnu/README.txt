...
for ARM Cortex-M3 projects, due to the support for the hardware FPU
(float-abi=hard).
***
...
Startup Code
============
The startup code for the stm32f103ze MCU used in this project is
located in the "3rd_party" folder in the following location:

3rd_party\stm32f103ze-ek\gcc\startup_stm32f103xe.c

The file startup_stm32f103xe.c provides a template of the recommended
